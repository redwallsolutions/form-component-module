...
class App extends React.Component {
  ...
  render() {
    return (
      <div style={{
        width:'500px',
        backgroundColor: this.state.mode === 'light' ? '#ebebeb' : '#191f37'
      }}>
        <ThemeProvider theme={{mode: this.state.mode, primaryContrastDark: '#2b324c', primaryDark: '#ebebeb'}}>
          <Form>
            ...
            <InputField field='with-after-icon'  appearance='secondary' placeholder="I have an after icon" label="What do you have?" icon={<FaUserAlt/>} afterIcon={<FaInfoCircle/>}/>
            <InputField
              field='Another'
